...
function header(prefix='..') { return `<header class="topbar" role="banner"><a href="/" class="brand-lockup text-decoration-none" aria-label="ConvertTextEasy - Página Inicial"><span class="navbar-logo"><img src="${prefix}/assets/img/iconeTextLab.png" alt="ConvertTextEasy" width="48" height="48" loading="lazy"></span><div><div class="brand-title">ConvertTextEasy</div><div class="brand-subtitle">Ferramentas de texto, dev e SEO</div></div></a><div class="topbar-actions"><button class="mobile-menu-btn" type="button" aria-label="Abrir menu de ferramentas" aria-expanded="false"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="18" x2="20" y2="18"/></svg></button><a class="theme-toggle text-decoration-none" href="/blog">Blog</a><button class="theme-toggle btn btn-sm" onclick="toggleTheme()" title="Alternar tema" aria-label="Alternar tema"><span id="themeIcon" aria-hidden="true">🌙</span><small>Tema</small></button></div></header>`; }
